...
public class SwimmingAdapter extends RecyclerView.Adapter<SwimmingAdapter.MyViewHolder> {
    ...
    @Override
    public SwimmingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sportsholder, parent, false);
        return new SwimmingAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(SwimmingAdapter.MyViewHolder holder, int position) {
